...
- [x] 1.1 Modify `/api/documents/upload/route.ts` to accept bookshop integration fields
...
- [x] 1.2 Add validation for bookshop-specific fields
...
- [x] 1.3 Implement bookshop item creation logic within upload flow
...
- [x] 1.4 Add error handling for partial failures
  - Handle case where document uploads but bookshop creation fails
  - Return appropriate warning message
  - Log errors for debugging
  - _Requirements: 4.4, 6.5_

- [x] 1.5 Update API response to include bookshop item information
...
- [x] 3.1 Create `components/upload/BookshopIntegrationSection.tsx`
  - Implement component with checkbox, dropdown, price input, and description
  - Add TypeScript interfaces for props
  - _Requirements: 1.1, 1.3_

- [x] 3.2 Implement "Add to Bookshop" checkbox with conditional field display
  - Show/hide bookshop fields based on checkbox state
  - Maintain form state
  - _Requirements: 1.2, 1.3_

- [x] 3.3 Add category dropdown with data from categories API
  - Fetch categories on component mount
  - Display categories in grouped structure
  - Handle loading and error states
  - _Requirements: 2.1, 2.2, 2.5_

- [x] 3.4 Implement price input with validation
...
- [x] 3.5 Add description textarea for bookshop-specific description
  - Optional field
  - Character limit if needed
  - _Requirements: 1.3_

- [x] 3.6 Add proper form validation and error display
  - Show validation errors inline
  - Highlight invalid fields
  - Display clear error messages
  - _Requirements: 6.1, 6.2, 6.3, 6.4_

- [x] 3.7 Ensure responsive design for mobile devices
...
- [x] 5.1 Verify `components/member/BookShop.tsx` displays newly uploaded documents
  - Test that new items appear immediately
  - Verify real-time updates
  - _Requirements: 5.1_

- [x] 5.2 Ensure documents are properly categorized and filterable
  - Test category filtering
  - Verify documents appear in correct categories
  - _Requirements: 5.2, 5.4_

- [x] 5.3 Verify document metadata is clearly displayed
  - Check title, description, price display
  - Verify category badge/label
  - _Requirements: 5.3_

- [x] 5.4 Test member can add bookshop items to study room
...
- [x] 6.1 Implement comprehensive client-side validation
  - Validate all required fields
  - Check data types and ranges
  - _Requirements: 6.1, 6.2_

- [x] 6.2 Add server-side validation with proper error messages
  - Validate on API endpoint
  - Return specific error messages
  - _Requirements: 6.1, 6.2, 6.4_

- [x] 6.3 Implement rollback strategy for partial failures
  - Handle document upload success + bookshop creation failure
  - Decide on rollback vs. warning approach
  - _Requirements: 4.4, 6.5_

- [x] 6.4 Add proper error logging and monitoring
  - Log errors to console/monitoring service
  - Track partial failure rates
  - _Requirements: Error Handling_

- [x] 6.5 Create user-friendly error messages
...
- [x] 7.1 Test upload without bookshop integration
  - Verify existing functionality still works
  - Test all content types
  - _Requirements: 1.4, 1.5_

- [x] 7.2 Test upload with bookshop integration
  - Test with all categories
  - Test with various price values
  - Verify bookshop item creation
  - _Requirements: 4.1, 4.2, 4.3_

- [x] 7.3 Test validation scenarios
...
- [x] 7.5 Test member bookshop experience
  - Browse newly uploaded documents
  - Filter by category
  - Add to study room
  - _Requirements: 5.1, 5.2, 5.3, 5.4, 5.5_

- [x] 7.6 Test data integrity
...
- [x] 8.1 Optimize API calls to reduce upload time impact
  - Minimize database queries
  - Use efficient queries
  - _Requirements: Performance_

- [x] 8.2 Implement proper loading states and progress indicators
  - Show upload progress
  - Indicate bookshop item creation
  - _Requirements: 7.5_

- [x] 8.3 Add caching for category and bookshop data
  - Cache categories on client
  - Set appropriate cache headers
  - _Requirements: Performance_

- [x] 8.4 Test performance with large files and catalogs
...
- [x] 9.1 Create user documentation for upload-to-bookshop workflow
  - Write step-by-step guide
  - Include screenshots
  - _Requirements: Documentation_

- [x] 9.2 Document API changes and new endpoints
  - Update API documentation
  - Document request/response formats
  - _Requirements: Documentation_

- [x] 9.3 Create troubleshooting guide for common issues
  - Document common errors
  - Provide solutions
  - _Requirements: Documentation_

- [x] 9.4 Update existing documentation to reflect new features
...
- [x] 10.1 Deploy backend API changes
  - Deploy enhanced upload endpoint
  - Deploy categories endpoint
  - _Requirements: Deployment_

- [x] 10.2 Deploy frontend UI enhancements
  - Deploy updated upload modal
  - Deploy BookshopIntegrationSection component
  - _Requirements: Deployment_

- [x] 10.3 Verify all functionality in production
  - Test upload workflow
  - Test bookshop integration
  - Test member experience
  - _Requirements: Deployment_

- [x] 10.4 Monitor deployment for errors
  - Check error logs
  - Monitor performance metrics
  - _Requirements: Deployment_

- [x] 10.5 Create rollback plan if issues arise
